...
var file_proto_helloworld_proto_rawDesc = []byte{
	...
	0x28, 0x0a, 0x08, 0x53, 0x79, 0x61, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x0d, 0x2e, 0x48, 0x65,
	0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0b, 0x2e, 0x48, 0x65, 0x6c,
	0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x12, 0x5a, 0x10, 0x70, 0x72, 0x6f,
...
var file_proto_helloworld_proto_depIdxs = []int32{
	0, // 0: Greeter.SyaHello:input_type -> HelloRequest
	1, // 1: Greeter.SyaHello:output_type -> HelloReply
...
type GreeterClient interface {
	SyaHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error)
}
...
func (c *greeterClient) SyaHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/Greeter/SyaHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServer interface {
	SyaHello(context.Context, *HelloRequest) (*HelloReply, error)
}
...
func (*UnimplementedGreeterServer) SyaHello(context.Context, *HelloRequest) (*HelloReply, error) {
...
func _Greeter_SyaHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServer).SyaHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Greeter/SyaHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).SyaHello(ctx, req.(*HelloRequest))
	}
...
var _Greeter_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SyaHello",
			Handler:    _Greeter_SyaHello_Handler,
		},
	},
